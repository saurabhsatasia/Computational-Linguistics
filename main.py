...
from speech_to_text.transcript_from_speech import generateTranscript
from spelling_corrector.spellcorrector import spell_corrector
from spot_keywords.keyword_spotter import AddMultiKeywords
